...
for key in records:
    ...
    for j, column in enumerate(record.columns):
        if column != records[key][j]:
            error = True
    if error:
        print('[check version -1 for record] update error on', records[key], 'and', updated_columns, ':', record.columns, ', correct:', records[key])
    else:
        # print('update success on ', records[key], 'and', updated_columns, ':', record.columns, ', correct:', records[key])
        pass
    ...
    for j, column in enumerate(record.columns):
        if column != records[key][j]:
            error = True
    if error:
        print('[check version -2 for record] update error on', records[key], 'and', updated_columns, ':', record.columns, ', correct:', records[key])
    else:
        # print('update success on ', records[key], 'and', updated_columns, ':', record.columns, ', correct:', records[key])
        pass
    ...
    for j, column in enumerate(record.columns):
        if column != updated_records[key][j]:
            error = True
    if error:
        print('[check version 0 for record] update error on', records[key], 'and', updated_columns, ':', record.columns, ', correct:', updated_records[key])
    else:
        # print('update success on ', records[key], 'and', updated_columns, ':', record.columns, ', correct:', records[key])
        pass
